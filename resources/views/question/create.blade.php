                                ...
                                <fieldset>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[0][answer]" type="text" class="form-control" id="answer1" >
                                        </div>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[1][answer]" type="text" class="form-control" id="answer2" >
                                        </div>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[2][answer]" type="text" class="form-control" id="answer3" >
                                        </div>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[3][answer]" type="text" class="form-control" id="answer4" >
                                        </div>
