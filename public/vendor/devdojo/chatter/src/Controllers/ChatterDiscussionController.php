    ...
    public function store(Request $request)
    {
        ...
        if (config('chatter.security.limit_time_between_posts')) {
            if ($this->notEnoughTimeBetweenDiscussion()) {
                ...
                $chatter_alert = [
                    ...
                    'chatter_alert'      => 'لطفا حداقل'.config('chatter.security.time_between_posts').$minute_copy.' in between submitting content.',
                    ];
        ...
        if ($post->id) {
            ...
            $chatter_alert = [
                ...
                'chatter_alert'      => 'با موفقیت ایجاد شد'.config('chatter.titles.discussion').'.',
                ];
            ...
            $chatter_alert = [
                'chatter_alert_type' => 'danger',
                'chatter_alert'      => '  مشکلی در ایجاد '.config('chatter.titles.discussion').'.',
                ];
